...
const CourseDetailsCard = ({ course, setConfirmationModal, handleBuyCourse }) => {
  ...
  return (
    <div className="flex w-[300px] left-0 flex-col gap-6 p-6 bg-white rounded-lg shadow-2xl border border-gray-100 transition-all duration-300 hover:shadow-3xl transform hover:-translate-y-2">
      {/* Course Thumbnail */}
      ...
      {/* Course Price */}
      <div className="flex items-center gap-2 text-3xl font-bold text-richblack-800">
      ...
      <div>
        <p className="flex items-center gap-2 mb-4 text-xl font-semibold text-richblack-800">
